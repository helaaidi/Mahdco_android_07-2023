...
public class coupe extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public static String selectedOF;
    TextInputEditText matela, numpip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ServiceTagCoupe.ServiceIsRun) {
            //register the services to run in background
            Intent intent = new Intent(this, ServiceTagCoupe.class);
            // start the services
            startService(intent);
        }
        ...
        numpip = findViewById(R.id.numpip);
            ...
            public void onClick(View v) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        data[9] = numpip.getText().toString();
                        data[10] = date;
