...
public final class scanoffmaint extends AppCompatActivity {
    ...
    public static String qrcode, result0;
    @NotNull
    public static final scanoffmaint.Companion Companion = new Companion((DefaultConstructorMarker)null);
    ...
    private final void setupCamera() {
        ...
        cameraProviderFuture.addListener((Runnable)(new Runnable() {
            public final void run() {
                try {
                    scanoffmaint.this.cameraProvider = (ProcessCameraProvider)cameraProviderFuture.get();
                    if (scanoffmaint.this.isCameraPermissionGranted()) {
                        scanoffmaint.this.bindCameraUseCases();
                    } else if (VERSION.SDK_INT >= 23) {
                        scanoffmaint.this.requestPermissions(new String[]{"android.permission.CAMERA"}, 1);
                    }
            ...
            if (var9 != null) {
                var9.setAnalyzer((Executor)cameraExecutor, (Analyzer)(new Analyzer() {
                    public final void analyze(@NotNull ImageProxy imageProxy) {
                        ...
                        scanoffmaint.this.processImageProxy(barcodeScanner, imageProxy);
                    }
                }));
            }
                ...
                public final void onSuccess(List barcodes) {
                    ...
                    if (barcode != null) {
                        ...
                        if (var10000 != null) {
                            ...
                            boolean var5 = false;
                            scanoffmaint.this.getScanResultTextView().setText((CharSequence)var3);
                            ...
                            if(qrcode.equals(ServiceNotificationmaint.digitex)) {
                                ...
                                try {
                                    ...
                                    postObject.put("id", ServiceNotificationmaint.id);
    ...
    private final boolean isCameraPermissionGranted() {
        scanoffmaint it = (scanoffmaint)this;
        boolean var3 = false;
        return ContextCompat.checkSelfPermission((Context)it, "android.permission.CAMERA") == 0;
    }

    // $FF: synthetic method
    public static final ProcessCameraProvider access$getCameraProvider$p(scanoffmaint $this) {
