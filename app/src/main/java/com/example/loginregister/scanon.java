...
public final class scanon extends AppCompatActivity {
    ...
    public static String qrcode, firstname, lastname, instructor, result1;
    public static boolean state = false;
    @NotNull
    public static final scanon.Companion Companion = new Companion((DefaultConstructorMarker)null);
    ...
    private final void setupCamera() {
        ...
        cameraProviderFuture.addListener((Runnable)(new Runnable() {
            public final void run() {
                try {
                    scanon.this.cameraProvider = (ProcessCameraProvider)cameraProviderFuture.get();
                    if (scanon.this.isCameraPermissionGranted()) {
                        scanon.this.bindCameraUseCases();
                    } else if (VERSION.SDK_INT >= 23) {
                        scanon.this.requestPermissions(new String[]{"android.permission.CAMERA"}, 1);
                    }
            ...
            if (var9 != null) {
                var9.setAnalyzer((Executor)cameraExecutor, (Analyzer)(new Analyzer() {
                    public final void analyze(@NotNull ImageProxy imageProxy) {
                        ...
                        scanon.this.processImageProxy(barcodeScanner, imageProxy);
                    }
                }));
            }
                ...
                public final void onSuccess(List barcodes) {
                    ...
                    if (barcode != null) {
                        ...
                        if (var10000 != null) {
                            ...
                            boolean var5 = false;
                            scanon.this.getScanResultTextView().setText((CharSequence)var3);
                            ...
                            if (state) {
                                ...
                                try {
                                    postObject.put("instant_call_maintainer",HomeFragment.timeon);
    ...
    private final boolean isCameraPermissionGranted() {
        scanon it = (scanon)this;
        boolean var3 = false;
        return ContextCompat.checkSelfPermission((Context)it, "android.permission.CAMERA") == 0;
    }

    // $FF: synthetic method
    public static final ProcessCameraProvider access$getCameraProvider$p(scanon $this) {
