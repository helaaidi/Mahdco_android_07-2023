...
public final class testscanbox extends AppCompatActivity {
    ...
    public static String qrmachine, qrcode;
    RequestQueue queue;
    @NotNull
    public static final testscanbox.Companion Companion = new testscanbox.Companion((DefaultConstructorMarker)null);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_testscanbox);
    ...
    private final void setupCamera() {
        ...
        cameraProviderFuture.addListener((Runnable)(new Runnable() {
            public final void run() {
                try {
                    testscanbox.this.cameraProvider = (ProcessCameraProvider)cameraProviderFuture.get();
                    if (testscanbox.this.isCameraPermissionGranted()) {
                        testscanbox.this.bindCameraUseCases();
                    } else if (VERSION.SDK_INT >= 23) {
                        testscanbox.this.requestPermissions(new String[]{"android.permission.CAMERA"}, 1);
                    }
            ...
            if (var9 != null) {
                var9.setAnalyzer((Executor)cameraExecutor, (Analyzer)(new Analyzer() {
                    public final void analyze(@NotNull ImageProxy imageProxy) {
                        ...
                        testscanbox.this.processImageProxy(barcodeScanner, imageProxy);
                    }
                }));
            }
                ...
                public final void onSuccess(List barcodes) {
                    ...
                    if (barcode != null) {
                        ...
                        if (var10000 != null) {
                            ...
                            boolean var5 = false;
                            testscanbox.this.getScanResultTextView().setText((CharSequence)var3);
    ...
    private final boolean isCameraPermissionGranted() {
        testscanbox it = (testscanbox)this;
        boolean var3 = false;
        return ContextCompat.checkSelfPermission((Context)it, "android.permission.CAMERA") == 0;
    }

    // $FF: synthetic method
    public static final ProcessCameraProvider access$getCameraProvider$p(testscanbox $this) {
    ...
    @Metadata(
            ...
            k = 1,
            d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0006\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000¨\u0006\b"},
            d2 = {"Lcom/example/loginregister/testscanbox$Companion;", "", "()V", "PERMISSION_CAMERA_REQUEST", "", "RATIO_16_9_VALUE", "", "RATIO_4_3_VALUE", "LoginRegister.app"}
    )
