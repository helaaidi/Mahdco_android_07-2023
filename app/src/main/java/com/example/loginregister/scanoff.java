...
public final class scanoff extends AppCompatActivity {
    ...
    @NotNull
    public static final scanoff.Companion Companion = new Companion((DefaultConstructorMarker)null);
    ...
    private final void setupCamera() {
        ...
        cameraProviderFuture.addListener((Runnable)(new Runnable() {
            public final void run() {
                try {
                    scanoff.this.cameraProvider = (ProcessCameraProvider)cameraProviderFuture.get();
                    if (scanoff.this.isCameraPermissionGranted()) {
                        scanoff.this.bindCameraUseCases();
                    } else if (VERSION.SDK_INT >= 23) {
                        scanoff.this.requestPermissions(new String[]{"android.permission.CAMERA"}, 1);
                    }
            ...
            if (var9 != null) {
                var9.setAnalyzer((Executor)cameraExecutor, (Analyzer)(new Analyzer() {
                    public final void analyze(@NotNull ImageProxy imageProxy) {
                        ...
                        scanoff.this.processImageProxy(barcodeScanner, imageProxy);
                    }
                }));
            }
                ...
                public final void onSuccess(List barcodes) {
                    ...
                    if (barcode != null) {
                        ...
                        if (var10000 != null) {
                            ...
                            boolean var5 = false;
                            scanoff.this.getScanResultTextView().setText((CharSequence)var3);
    ...
    private final boolean isCameraPermissionGranted() {
        scanoff it = (scanoff)this;
        boolean var3 = false;
        return ContextCompat.checkSelfPermission((Context)it, "android.permission.CAMERA") == 0;
    }

    // $FF: synthetic method
    public static final ProcessCameraProvider access$getCameraProvider$p(scanoff $this) {
