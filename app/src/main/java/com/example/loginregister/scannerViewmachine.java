...
public class scannerViewmachine extends AppCompatActivity implements ZXingScannerView.ResultHandler
{
    ZXingScannerView scannerViewmachine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scannerViewmachine= new ZXingScannerView(this);
        setContentView(scannerViewmachine);
        ...
        Dexter.withContext(getApplicationContext())
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                        scannerViewmachine.startCamera();
                    }
    ...
    protected void onPause() {
        super.onPause();
        scannerViewmachine.stopCamera();
    }

    @Override
    protected void onResume() {
        super.onResume();
        scannerViewmachine.setResultHandler(this);
        scannerViewmachine.startCamera();
    }
}