...
public class Rend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> adapter=new ArrayAdapter<>(Rend.this, android.R.layout.simple_list_item_1,arrayList);
